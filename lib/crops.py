...
class crops:
    ...
    def SetTC(self):
        ...
        try: 
            tc_install=open(os.path.join(self.topdir,os.path.join(self.c_tc_install_path,self.c_tc_manager_script)), "r")
    ...
    def SetRepo(self):
        ...
        try: 
            repo_install=open(os.path.join(self.topdir,os.path.join(self.d_repo_install_path,self.d_repo_manager_script)), "r")
    ...
    def SetPackages(self):
        ...
        try: 
            pkgs_install=open(os.path.join(self.topdir,os.path.join(self.c_packages_path,"packages."+ self.c_host_os + "-" + self.c_host_os_version)), "r")
